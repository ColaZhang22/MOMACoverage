...
class Mlp(Model):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        print(
            f"[policy input] group={self.agent_group} is_critic={self.is_critic} "
            f"in_keys={self.in_keys} input_features={self.input_features} output_features={self.output_features}"
        )
