...
from .fheragent.common import FHERagentClass, FHERTask
from .sar.common import SARClass, SARTask
...
tasks = [VmasTask, Smacv2Task, PettingZooTask, MeltingPotTask, MAgentTask, FHERTask, SARTask]
# tasks = [FHERTask]
